    ...
    async run(client, message, args) {
        ...
        let f = async (interaction) => {
            ...
            if (interaction.customId.startsWith('rps')) {
                ...
                // Editing the embed
                embed.description = `I chose ${botMove.txt}! ${win == 0 ? 'You lost!' : (win == 1 ? 'We tied!' : 'You win!')} (${userMove.emoji} ${win == 0 ? '<' : (win == 1 ? '=' : '>')} ${botMove.emoji}) This command was coded by Melvin#5155!`;
